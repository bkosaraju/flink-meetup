...
trait DefaultConfig {
  lazy val DEFAULT_CHECKPOINT_INTERVAL = 120000 //defaultCheckpointInterval
  lazy val MIN_PAUSE_CHECKPOINT_INTERVAL = 120000 //minPauseBetweenCheckPoints
  lazy val CHECK_POINT_TIMEOUT = 120000 //checkpointTimeout
